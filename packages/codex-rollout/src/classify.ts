 ...
 * - `reasoning` carries `encrypted_content`, which is 85.2% of that record's
 *   bytes and 6.46% of the whole corpus, and is opaque outside OpenAI's own
 *   systems. It is never read; only its presence is recorded.
 *
 * @module
 */
