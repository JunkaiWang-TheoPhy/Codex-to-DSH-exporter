 ...
 */
export function generationLogFilename(version: number, compression: Compression = 'zstd'): string {
...
export function parseGenerationLogFilename(
  ...
  if (digits === undefined || digits.length > 1 && digits.startsWith('0')) return undefined;
